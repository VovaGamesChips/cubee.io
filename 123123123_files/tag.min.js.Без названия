...
function aipAPI() {
	...
	if(aiptag.settings.iVideoAdUnitBidders) {
		this.videoAdUnit = [];
		this.videoAdUnit["cewb.io_preroll"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
bids: [
	...
	},
	{
		...
		params: {
			...
			this.adUnits['cewb-io_300x600'] = [{
		code: 'cewb-io_300x600',
		mediaTypes: {
			banner: {
				sizes: [300, 600]
			}
		...
		this.adSlots['cewb-io_300x600'] = {adunit: 'cewb.io_300x600', sizes: [300, 600], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['cewb-io_300x600'] = [{slotID: 'cewb-io_300x600', slotName: '/421469808/cewb.io_300x600', sizes: [[300, 600]]}];
		}
		this.requestManager['cewb-io_300x600'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['cewb-io_970x250'] = [{
		code: 'cewb-io_970x250',
		mediaTypes: {
			banner: {
				sizes: [970, 250]
			}
		...
		this.adSlots['cewb-io_970x250'] = {adunit: 'cewb.io_970x250', sizes: [970, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['cewb-io_970x250'] = [{slotID: 'cewb-io_970x250', slotName: '/421469808/cewb.io_970x250', sizes: [[970, 250]]}];
		}
		this.requestManager['cewb-io_970x250'] = {adserverRequestSent: false, aps: false, prebid: false};
	...
	*/
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['cewb-io_300x600'], aRemoveBidders);
					this.removeBidders(this.adUnits['cewb-io_970x250'], aRemoveBidders);
		
		//removeBidders from preroll
						this.removeBidders([this.videoAdUnit["cewb.io_preroll"]], aRemoveBidders);
					}
}

aipAPI.prototype.cutomSizeConfig = function() {
		try {
		this.adSlots['cewb-io_300x600']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
		this.adUnits['cewb-io_300x600 '][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
		
		this.adSlots['cewb-io_970x250']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];
		this.adUnits['cewb-io_970x250'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [300, 250], [728, 90]];
...
aiptag.settings.iAmazonAds&&!function(a,c,b,d,e,f,m){c[a]||(c[a]={init:function(){c[a]._Q.push(["i",arguments])},fetchBids:function(){c[a]._Q.push(["f",arguments])},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]},f=b.createElement(d),f.async=!0,f.src=e,m=b.getElementsByTagName(d)[0],m.parentNode.insertBefore(f,m))}("apstag",window,document,"script","//c.amazon-adsystem.com/aax2/apstag.js");
...
aipAPI.prototype.initGDPR=function(){function a(e,f,m,l,g){"undefined"===typeof g&&(g="/");"undefined"===typeof l?(l=(window&&window.location&&window.location.hostname||"").split("."),l=";domain="+(1<l.length?l.slice(-2).join("."):"")):l="";var n=new Date;n.setSeconds(n.getSeconds()+m);document.cookie=e+" = "+f+l+";path="+g+";max-age="+m+";Expires="+n.toUTCString()}function c(){aipAPItag.start();try{var e=new CustomEvent("aip_consentnotrequired");document.dispatchEvent(e)}catch(f){aipAPItag.logError(f)}}
...
"bottom"===aiptag.cmp.position?15920:13566;window.gdprAppliesGlobally=!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_host="consentmanager.mgr.consensu.org";window.cmp_logoclick="https://adinplay.com/?utm_source=publishers&utm_medium=cmp";window.cmp_cdn="cdn.consentmanager.mgr.consensu.org";(function(){var f="",m="_en";"cmp_getlang"in window&&(f=window.cmp_getlang().toLowerCase(),m="_"+f);var l=document.createElement("script");l.src="https://"+window.cmp_host+"/delivery/cmp.php?id="+
window.cmp_id+"&h="+encodeURIComponent(location.href)+"&"+window.cmp_params+(0<document.cookie.length?"&__cmpfcc=1":"")+"&l="+f+"&o="+(new Date).getTime();l.type="text/javascript";l.setAttribute("data-cmp-ab","1");l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):document.write(l.outerHTML);l=document.createElement("script");l.src="https://"+window.cmp_cdn+"/delivery/cmp"+m+".min.js";l.type="text/javascript";l.setAttribute("data-cmp-ab",
"1");l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):document.write(l.outerHTML);window.cmp_addFrame=function(g){if(!window.frames[g])if(document.body){var n=document.createElement("iframe");n.style.cssText="display:none";n.name=g;document.body.appendChild(n)}else window.setTimeout('window.cmp_addFrame("'+g+'")',10)};window.cmp_rc=function(g){for(var n=document.cookie,r="",u=0;""!=n&&100>u;){for(u++;" "==n.substr(0,1);)n=
n.substr(1,n.length);var v=n.substring(0,n.indexOf("=")),y=-1!=n.indexOf(";")?n.substring(n.indexOf("=")+1,n.indexOf(";")):n.substr(n.indexOf("=")+1,n.length);g==v&&(r=y);v=n.indexOf(";")+1;0==v&&(v=n.length);n=n.substring(v,n.length)}return r};window.cmp_stub=function(){var g=arguments;__cmapi.a=__cmapi.a||[];if(g.length)if("ping"===g[0])if(2===g[1])g[2]({gdprApplies:gdprAppliesGlobally,cmpLoaded:!1,cmpStatus:"stub",displayStatus:"hidden",apiVersion:"2.0",cmpId:31},!0);else g[2]({gdprAppliesGlobally:gdprAppliesGlobally,
cmpLoaded:!1},!0);else if("getUSPData"===g[0])g[2]({version:1,uspString:window.cmp_rc("")},!0);else if("getTCData"===g[0])__cmapi.a.push([].slice.apply(g));else if("addEventListener"===g[0])__cmapi.a.push([].slice.apply(g));else if(4==g.length&&!1===g[3])g[2]({},!1);else __cmapi.a.push([].slice.apply(g));else return __cmapi.a};window.cmp_msghandler=function(g){var n="string"===typeof g.data;try{var r=n?JSON.parse(g.data):g.data}catch(v){r=null}if("object"===typeof r&&null!==r&&"__cmpCall"in r){var u=
r.__cmpCall;window.__cmp(u.command,u.parameter,function(v,y){var w={__cmpReturn:{returnValue:v,success:y,callId:u.callId}};g.source.postMessage(n?JSON.stringify(w):w,"*")})}"object"===typeof r&&null!==r&&"__cmapiCall"in r&&(u=r.__cmapiCall,window.__cmapi(u.command,u.parameter,function(v,y){var w={__cmapiReturn:{returnValue:v,success:y,callId:u.callId}};g.source.postMessage(n?JSON.stringify(w):w,"*")}));"object"===typeof r&&null!==r&&"__uspapiCall"in r&&(u=r.__uspapiCall,window.__uspapi(u.command,
u.version,function(v,y){var w={__uspapiReturn:{returnValue:v,success:y,callId:u.callId}};g.source.postMessage(n?JSON.stringify(w):w,"*")}));"object"===typeof r&&null!==r&&"__tcfapiCall"in r&&(u=r.__tcfapiCall,window.__tcfapi(u.command,u.version,function(v,y){var w={__tcfapiReturn:{returnValue:v,success:y,callId:u.callId}};g.source.postMessage(n?JSON.stringify(w):w,"*")},u.parameter))};window.cmp_setStub=function(g){g in window&&("function"===typeof window[g]||"object"===typeof window[g]||"undefined"!==
...
l+"</a>"}}catch(A){aipAPItag.logError(A)}try{var u=new CustomEvent("aip_consent",{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(u);var v=m.getCMPData();if("vendorConsents"in v)if("755"in v.vendorConsents&&v.vendorConsents["755"])try{var y=new CustomEvent("aip_consentapproved",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(y)}catch(A){aipAPItag.logError(A)}else try{var w=new CustomEvent("aip_consentrejected",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(w)}catch(A){aipAPItag.logError(A)}}catch(A){aipAPItag.logError(A)}},
!1],null);__cmp("addEventListener",["init",function(f,m){try{var l=new CustomEvent("aip_consentinit",{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(l)}catch(g){aipAPItag.logError(g)}},!1],null);__cmp("addEventListener",["settings",function(f,m){try{clearTimeout(aipAPItag.CMPloadTimeout)}catch(g){aipAPItag.logError(g)}try{var l=new CustomEvent("aip_consentsettings",{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(l)}catch(g){aipAPItag.logError(g)}},!1],null);__cmp("addEventListener",
["consentscreen",function(f,m){try{var l=new CustomEvent("aip_consentscreen",{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(l)}catch(g){aipAPItag.logError(g)}},!1],null);__cmp("addEventListener",["consentscreenoff",function(f,m){try{var l=new CustomEvent("aip_consentscreenoff",{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(l)}catch(g){aipAPItag.logError(g)}},!1],null);__cmp("addEventListener",["liestablished",function(f,m){try{var l=new CustomEvent("aip_consentliestablished",
{detail:{eventname:f,cmpobject:m}});document.dispatchEvent(l)}catch(g){aipAPItag.logError(g)}},!1],null)}if(!0===aiptag.cmp.show)if(aipAPItag.log("aiptag.cmp.show = true"),"true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),b();else if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, GDPR Consent not required"),c();else{var d=new XMLHttpRequest;d.onreadystatechange=function(){if(d.readyState==
...
aipAPI.prototype.urlParamUpdate=function(a,c,b,d){var e=new RegExp("[\\?&]"+c+"=([^&#]*)","i"),f=e.exec(a);if(null===f)d=/\?/.test(a),a=a+(d?"&":"?")+c+"="+b;else{var m=f[0].charAt(0);a=!0===d?a.replace(e,m+c+"="+f[1]+"%26"+b):a.replace(e,m+c+"="+b)}return a};
...
aipAPI.prototype.getAllBids=function(){(function(){function a(e,f){Object.keys(e).forEach(function(m){e[m].bids.forEach(function(l){f(m,l)})})}var c=aip_pbjs.getAllWinningBids(),b=[];a(aip_pbjs.getBidResponses(),function(e,f){b.push({bid:f,adunit:e,adId:f.adId,bidder:f.bidder,time:f.timeToRespond,cpm:f.cpm,msg:f.statusMessage,rendered:!!c.find(function(m){return m.adId==f.adId})})});a(aip_pbjs.getNoBids&&aip_pbjs.getNoBids()||{},function(e,f){b.push({msg:"no bid",adunit:e,adId:f.bidId,bidder:f.bidder})});
...
aipAPI.prototype.removeBidders=function(a,c){try{a.forEach(function(b,d){var e=b.bids,f=[];e&&0<e.length&&e.forEach(function(m,l){-1===c.indexOf(m.bidder)&&f.push(m)});a[d].bids=f})}catch(b){aipAPItag.logError(b)}};
...
document.getElementById("aipPauseButtonContainer");h.parentNode.removeChild(h)}catch(p){aipAPItag.logError(p)}}function m(){aipAPItag.sendEvent("video-ad-resumed")}function l(h){z("EXCEPTION",{name:h.name,message:h.message,stack:h.stack})}function g(h){var p="",t="",x="";try{p=h.getAd().getContentType(),t=h.getAd().getMinSuggestedDuration(),x=h.getAd().getCreativeId()}catch(E){l(E)}z("CONTENT_PAUSE_REQUESTED",{contentType:p,creativeId:x,minSuggestedDuration:t})}function n(h){y();b.style.display="block";
